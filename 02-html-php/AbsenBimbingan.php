        ...
        <div>
            <form action="" method="post">
                <div class="form-group row">
                    <label for="pembimbing" class="col-2 col-form-label">ID Pembimbing</label>
                        <div class="col-10">
                            <input class="form-control" type="text" name="pembimbing" id="pembimbing">
                        </div>
                </div>
                ...
                <div class="form-group row">
                    <label for="tanggal" class="col-2 col-form-label">Tanggal Bimbingan</label>
                        <div class="col-10">
                            <input class="form-control" type="date" value="2020-10-01" id="tanggal" name="tanggal">
                        </div>
                </div>
                ...
                <p class="font-weight-bold">Mahasiswa</p>
                    ...
                    <div class="form-group row">
                        <label for="kelompok" class="col-2 col-form-label">ID Kelompok</label>
                            <div class="col-10">
                                <input class="form-control" type="text" id="kelompok" name="kelompok">
                            </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="topik" class="col-2 col-form-label">Topik</label>
                            <div class="col-10">
                                <input class="form-control" type="text" id="topik" name="topik">
                            </div>
                    </div>
