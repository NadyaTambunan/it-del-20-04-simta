      ...
      <h2 class="alert text-center mt-3">Membentuk Kelompok TA</h2>
            ...
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" name="stud_name" id="stud_name" required>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control" name="nim_1" id="nim_1" required>
              </div>
               </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" name="name_1" id="name_1" required>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" name="nim_2" id="nim_2" required>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" name="name_2" id="name_2" required>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" name="nim_3" id="nim_3" >
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" name="name_3" id="name_3" >
                </div>
              </div>
            </div>
